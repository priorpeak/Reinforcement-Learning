...
def load_data(dataset_path=DATASET_PATH, transform=dense_transforms.ToTensor(), num_workers=12, batch_size=128):
...
class PyTux:
    ...
    def rollout(self, track, controller, planner=None, max_frames=5000, verbose=False, data_callback=None):
        """
