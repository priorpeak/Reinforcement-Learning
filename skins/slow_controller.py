...
def control(aim_point, current_vel, steer_gain=6, skid_thresh=1.5, target_vel=10):
    import numpy as np
...
if __name__ == '__main__':
    ...
    def test_controller(args):
        ...
        for t in args.track:
            ...
            steps, how_far = pytux.rollout(t, control, max_frames=5000, verbose=args.verbose)
            print(steps, how_far)
        pytux.close()
